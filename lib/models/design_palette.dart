    ...
    switch (preset) {
      case DesignPreset.material:
        return const DesignPalette(
          ...
          neutral: [
            'FFFAFAFA', 'FFF5F5F5', 'FFEEEEEE', 'FFE0E0E0', 'FFBDBDBD',
            'FF9E9E9E', 'FF757575', 'FF616161', 'FF424242', 'FF212121',
          ],
      ...
      case DesignPreset.vibrant:
        return const DesignPalette(
          ...
          textOnPrimary: 'FFFFFFFF',
          neutral: [
            'FFFAFAFA', 'FFF5F5F5', 'FFE5E5E5', 'FFD4D4D4', 'FFA3A3A3',
            'FF737373', 'FF525252', 'FF404040', 'FF262626', 'FF171717',
          ],
      ...
      case DesignPreset.minimal:
        return const DesignPalette(
          ...
          neutral: [
            'FFFAFAFA', 'FFF5F5F5', 'FFE5E5E5', 'FFD4D4D4', 'FFA3A3A3',
            'FF737373', 'FF525252', 'FF404040', 'FF262626', 'FF0A0A0A',
          ],
